...
?>
    <div class="card mx-7 my-3">
      ...
      <hr class="dark horizontal opacity-10 mx-5">
      <div class="card-body p-2 pt-2">
        <div class="panel-body my-3" id="serviceList">
          <table class="table-responsive table-sm table align-items-center mb-0" id="tblistado">
            <thead>
              <tr>
        ...
        <div class="panel-body" id="formPane">
          <div class="px-3">
