    ...
    <div class="card my-4 m-7">
      <div class="card-header p-3 pt-2">
        ...
        <div class="text-end pt-1">
          ...
          <button class="btn btn-link mb-n" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button>
        </div>
      </div>
      ...
      <div class="card-body p-3">
        ...
        <div class="panel-body py-4" id="listadoregistros">
          <table id="tblistado" class="table-responsive table-sm align-items-center mb-0">
            <thead>
              <tr>
        ...
        <div class="panel-body" id="formularioregistros">
          <form name="formulario" id="formulario" method="POST">
            <div class="input-group input-group-relative my-3 gap-2 align-items-center">
              <label>Nombre(*):</label>
            ...
            <!--<div class="input-group input-group-static my-3 gap align-items-center">
              ...
              <input type="text" name="num_documento" id="idsala" class="fotm-control" required></input>
            </div>-->
            <div class="input-group input-group-static my-3 gap-2 align-items-center">
